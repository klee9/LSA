...
{
	printk(KERN_INFO "Entering rw sema module...\n");
...
{
	printk("rw sema linked list insert time: %llu ns, count: %llu", add_time, add_cnt);	
	printk("rw sema linked list search time: %llu ns, count: %llu", search_time, search_cnt);	 
	printk("rw sema linked list delete time: %llu ns, count: %llu", del_time, del_cnt);	
